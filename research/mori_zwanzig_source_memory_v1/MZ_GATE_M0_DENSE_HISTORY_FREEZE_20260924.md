...
- source bank: the exact 630 free PMFS support cells from the independently reviewed Gate 1A bank;
- source z: 0.20 m;
...
For every source in the 630-source bank generate **three independent W2 realizations**:
