...
def generate_launch_description():
    return LaunchDescription([
        ...
        Node(
            ...
            name='vgr_uav_sim',
            additional_env={'PYTHONPATH': os.environ['TNQC_RUNTIME_PYTHONPATH'] + ':' + os.environ.get('PYTHONPATH', '')},
            output='screen',
            parameters=[{
        ...
        # The supervisor starts at PMFS readiness, then waits for terminal I/O.
        ExecuteProcess(cmd=['python3', os.environ['TNQC_H01_SUPERVISOR'],
                            '--run-dir', LaunchConfiguration('run_dir')], output='screen'),
    ])
