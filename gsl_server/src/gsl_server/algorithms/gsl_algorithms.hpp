...
#endif
#if ENABLE_SENSOR_AWARE_SC_PF
    #define SAISC_PF_NAME "SensorAwareSurgeCastPF"
    #include <gsl_server/algorithms/SensorAwareSurgeCastPF/SensorAwareSurgeCastPF.hpp>
#else
