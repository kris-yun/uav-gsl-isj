...
RUN_ROOT=${CSTAR_CORE_RUN_ROOT:-/mnt/hgfs/workspace/CSTAR_CORE_M1_ENSEMBLE_H01_SEED8_20260908_R1}
...
for ARM in A0 M1E; do
  HOUSE=H01 SEED=8 SENSOR_SEED=12 ARM="$ARM" RUN_ROOT="$RUN_ROOT" REPO_ROOT="$REPO_ROOT" \
    ...
    GIT_COMMIT=e2db3a18ec88772bc782c1d2831e22f698fa641f \
    bash "$REPO_ROOT/closed_loop/ctpi/run_ctpi_fasttrack_case_safe_20260903.sh"
done

printf '%s\n' "CSTAR_CORE_M1_ENSEMBLE_H01_SEED8_COMPLETE"
