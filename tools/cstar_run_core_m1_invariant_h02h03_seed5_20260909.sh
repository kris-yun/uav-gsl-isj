...
RUN_ROOT=${CSTAR_CORE_RUN_ROOT:-/mnt/hgfs/workspace/CSTAR_CORE_M1_INVARIANT_H02H03_SEED5_20260909_R1}
...
GIT_COMMIT=e1626c39095335da7e329be468919d00405e98a1
...
for HOUSE in H02 H03; do
  for ARM in A0 M1G; do
    HOUSE="$HOUSE" SEED=5 SENSOR_SEED=12 ARM="$ARM" RUN_ROOT="$RUN_ROOT" REPO_ROOT="$REPO_ROOT" \
...
printf '%s\n' "CSTAR_CORE_M1_INVARIANT_H02H03_SEED5_COMPLETE"
