...
RUN_ROOT=${CSTAR_CORE_RUN_ROOT:-/mnt/hgfs/workspace/CSTAR_CORE_M1_SEQ_H01_SEED10_20260908_R1}
...
HOUSE=H01 SEED=10 SENSOR_SEED=12 ARM=M1S RUN_ROOT="$RUN_ROOT" REPO_ROOT="$REPO_ROOT" \
  ...
  DOMAIN_ID=231 TIMEOUT_SEC=240.0 METHOD=CTPI_G2_M1_M2 METHOD_FAMILY=ctpi_two_module \
...
printf '%s\n' "CSTAR_CORE_M1_SEQ_H01_SEED10_ONLY_COMPLETE"
