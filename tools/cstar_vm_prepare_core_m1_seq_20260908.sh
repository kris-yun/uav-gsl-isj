...
SOURCE_BUILD=/dev/shm/cstar_pmfs_core_m1_build_20260908
TARGET_BUILD=/dev/shm/cstar_pmfs_core_m1_seq_build_20260908
...
printf '%s\n' "CSTAR_CORE_M1_SEQ_VM_PREPARE=PASS" "TARGET_BUILD=$TARGET_BUILD"
