...
SOURCE_BUILD=/dev/shm/cstar_pmfs_core_m1_stop_build_20260908
TARGET_BUILD=/dev/shm/cstar_pmfs_core_m1_ensemble_build_20260908
...
printf '%s\n' "CSTAR_CORE_M1_ENSEMBLE_VM_PREPARE=PASS" "TARGET_BUILD=$TARGET_BUILD"
