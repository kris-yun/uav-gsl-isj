...
RUN_ROOT=${CSTAR_CORE_RUN_ROOT:-/mnt/hgfs/workspace/CSTAR_CORE_M1_H01_SEED11_20260908_R4}
...
for ARM in A0 M1C; do
    ...
    DOMAIN_ID=227 TIMEOUT_SEC=240.0 METHOD=CTPI_G2_M1_M2 METHOD_FAMILY=ctpi_two_module \
    GIT_COMMIT=dc4f2bf83d1a137393ad01b026a53a1fa7204f0b \
    bash "$REPO_ROOT/closed_loop/ctpi/run_ctpi_fasttrack_case_safe_20260903.sh"
done

printf '%s\n' "CSTAR_CORE_M1_H01_SEED11_COMPLETE"
