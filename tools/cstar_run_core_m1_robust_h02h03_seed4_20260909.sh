...
RUN_ROOT=${CSTAR_CORE_RUN_ROOT:-/mnt/hgfs/workspace/CSTAR_CORE_M1H_H02H03_SEED4_20260909_R1}
...
for HOUSE in H02 H03; do
  for ARM in A0 M1H; do
    HOUSE="$HOUSE" SEED=4 SENSOR_SEED=12 ARM="$ARM" RUN_ROOT="$RUN_ROOT" REPO_ROOT="$REPO_ROOT" \
...
printf '%s\n' "CSTAR_CORE_M1H_H02H03_SEED4_COMPLETE"
