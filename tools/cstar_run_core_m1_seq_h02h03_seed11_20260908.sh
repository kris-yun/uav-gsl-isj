...
RUN_ROOT=${CSTAR_CORE_RUN_ROOT:-/mnt/hgfs/workspace/CSTAR_CORE_M1_SEQ_H02H03_SEED11_20260908_R1}
BUILD_ROOT=/dev/shm/cstar_pmfs_core_m1_seq_build_20260908
...
for HOUSE in H02 H03; do
  for ARM in A0 M1S; do
    HOUSE="$HOUSE" SEED=11 SENSOR_SEED=12 ARM="$ARM" RUN_ROOT="$RUN_ROOT" REPO_ROOT="$REPO_ROOT" \
      ...
      DOMAIN_ID=229 TIMEOUT_SEC=240.0 METHOD=CTPI_G2_M1_M2 METHOD_FAMILY=ctpi_two_module \
      GIT_COMMIT=46b64435a4f5a9652f6539dcc8a8c56c453f9f67 \
      bash "$REPO_ROOT/closed_loop/ctpi/run_ctpi_fasttrack_case_safe_20260903.sh"
  done
done

printf '%s\n' "CSTAR_CORE_M1_SEQ_H02H03_SEED11_COMPLETE"
