...
RUN_ROOT=${CSTAR_CORE_RUN_ROOT:-/mnt/hgfs/workspace/CSTAR_CORE_M1_SEQ_H01_SEED11_20260908_R1}
...
for ARM in A0 M1S; do
  HOUSE=H01 SEED=11 SENSOR_SEED=12 ARM="$ARM" RUN_ROOT="$RUN_ROOT" REPO_ROOT="$REPO_ROOT" \
    ...
    DOMAIN_ID=228 TIMEOUT_SEC=240.0 METHOD=CTPI_G2_M1_M2 METHOD_FAMILY=ctpi_two_module \
...
printf '%s\n' "CSTAR_CORE_M1_SEQ_H01_SEED11_COMPLETE"
