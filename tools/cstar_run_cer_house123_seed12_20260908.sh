...
RUN_ROOT=${CSTAR_CER_RUN_ROOT:-/mnt/hgfs/workspace/CSTAR_CER_M12_HOUSE123_SEED12_20260908_R2}
BUILD_ROOT=/dev/shm/cstar_pmfs_cer_build_r3_20260908
...
for HOUSE in H01 H02 H03; do
  for ARM in A0 M1 M1M2; do
    HOUSE="$HOUSE" SEED=12 ARM="$ARM" RUN_ROOT="$RUN_ROOT" REPO_ROOT="$REPO_ROOT" \
      ...
      GIT_COMMIT=484cac2828faf095372d352c3128c5a2e366bf34+cer-dev-20260908 \
      bash "$REPO_ROOT/closed_loop/ctpi/run_ctpi_fasttrack_case_safe_20260903.sh"
  done
done
echo CSTAR_CER_M12_HOUSE123_SEED12_COMPLETE
