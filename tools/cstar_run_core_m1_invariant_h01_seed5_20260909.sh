...
RUN_ROOT=${CSTAR_CORE_RUN_ROOT:-/mnt/hgfs/workspace/CSTAR_CORE_M1_INVARIANT_H01_SEED5_20260909_R1}
...
for ARM in A0 M1G; do
  HOUSE=H01 SEED=5 SENSOR_SEED=12 ARM="$ARM" RUN_ROOT="$RUN_ROOT" REPO_ROOT="$REPO_ROOT" \
...
printf '%s\n' "CSTAR_CORE_M1_INVARIANT_H01_SEED5_COMPLETE"
