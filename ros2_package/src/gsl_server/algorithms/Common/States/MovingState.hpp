...
namespace GSL
{
    ...
    protected:
        ...
        void writeNavigationTrace(const char* event, const char* outcome);
    ...
    protected:
        ...
        std::ofstream navigation_trace_file_;
        bool navigation_trace_enabled_ = false;
        uint64_t navigation_goal_counter_ = 0;
        uint64_t active_navigation_goal_id_ = 0;
