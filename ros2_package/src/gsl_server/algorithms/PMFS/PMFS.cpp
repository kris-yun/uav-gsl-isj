...
namespace GSL
{
    ...
    void PMFS::declareParameters()
    {
        ...
        if (pfdiMode != "off" && pfdiMode != "cer_m1" && pfdiMode != "cer_m1_m2" &&
            ...
            throw std::invalid_argument("pfdi_mode must be off, cer_m1, cer_m1_m2, cer_ratio_m1, cer_ratio_m1_m2, cer_core_m1, cer_core_seq_m1, cer_core_stop_m1, cpir_m1, cpir_a1, cpir_a2, cpir_a3, cpir_m1_m3, ctpi_f00, ctpi_f01, ctpi_f10, ctpi_f11, sd, tadm, joint, al, pc_aci, me_aci, me_aci_shadow, ec_edcl, or ec_edcl_shadow");
