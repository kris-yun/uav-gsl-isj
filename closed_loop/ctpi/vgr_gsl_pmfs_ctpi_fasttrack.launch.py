...
def _validate_ctpi_launch(context):
    ...
    if identity == ('CTPI_CREL_TSDC_PIP', 'ctpi_three_module'):
        ...
        allowed = {'off', 'ctpi_f00', 'ctpi_f01', 'cer_m1', 'cer_m1_m2',
                   ...
                   'cer_core_invariant_m1', 'cer_core_robust_m1', 'cer_core_phic_m1'}
        ...
        allowed = {'off', 'cer_m1', 'cer_m1_m2', 'cer_ratio_m1', 'cer_ratio_m1_m2',
                   ...
                   'cer_core_eventtime_m1', 'cer_core_invariant_m1', 'cer_core_robust_m1', 'cer_core_phic_m1'}
    else:
    ...
    expected_ablation = {
        ...
        'cer_core_invariant_m1': 'M1G',
        'cer_core_robust_m1': 'M1H',
        'cer_core_phic_m1': 'M1PHIC',
    }[mode]
    ...
    if mode in {'cer_core_eventtime_m1', 'cer_core_invariant_m1', 'cer_core_robust_m1', 'cer_core_phic_m1'} and expected_steps != 1:
